...
val JOB_PROFESSIONS_BY_SECTOR: Map<String, List<String>> = mapOf(
    "HEALTHCARE" to listOf("DOCTOR", "DENTIST", "PHARMACIST", "NURSE", "PHYSIOTHERAPIST", "OCCUPATIONAL_THERAPIST", "MIDWIFE", "MEDICAL_ASSISTANT", "PSYCHOLOGIST", "PARAMEDIC", "LAB_TECHNICIAN", "OTHER_HEALTHCARE"),
    "IT" to listOf("COMPUTER_SCIENTIST", "SOFTWARE_DEVELOPER", "WEB_DEVELOPER", "APP_DEVELOPER", "IT_SYSTEM_ADMIN", "NETWORK_ADMIN", "CYBERSECURITY", "DATA_SCIENTIST_AI", "DATABASE_ADMIN", "IT_SUPPORT", "SAP_SPECIALIST", "DEVOPS_CLOUD", "IT_PROJECT_MANAGER"),
    "SKILLED_TRADES" to listOf("ELECTRICIAN", "INSTALLER", "HEATING_SANITARY", "MECHANIC", "AUTO_MECHATRONIC", "LOCKSMITH", "CARPENTER", "ROOF_CARPENTER", "MASON", "PAINTER", "ROOFER", "TILER", "METAL_WORKER", "PLANT_MECHANIC", "INDUSTRIAL_MECHANIC", "MECHATRONICS_TECH", "CNC_SPECIALIST"),
    "CONSTRUCTION" to listOf("CIVIL_ENGINEER", "ARCHITECT", "SITE_MANAGER", "STRUCTURAL_ENGINEER", "SURVEYING", "CIVIL_WORKS", "BUILDING_CONSTRUCTION", "ROAD_CONSTRUCTION", "CONSTRUCTION_HELPER"),
    "OFFICE_ADMIN" to listOf("BUSINESS_CLERK", "CASE_WORKER", "ADMINISTRATION", "RECEPTION", "SECRETARIAT", "ASSISTANT", "HR", "ACCOUNTING", "CONTROLLING", "PURCHASING", "QUALITY_MANAGEMENT"),
    "FINANCE" to listOf("BANKING", "INSURANCE", "TAX_ADVISOR", "AUDITOR", "FINANCIAL_ADVISOR", "CONTROLLER", "ACCOUNTANT", "REAL_ESTATE_FINANCE", "MANAGEMENT_CONSULTING"),
    "SALES" to listOf("SALESPERSON", "RETAIL", "WHOLESALE", "CASHIER", "STORE_MANAGEMENT", "FIELD_SALES", "SALES_REP", "ECOMMERCE", "CUSTOMER_ADVISOR"),
    "LOGISTICS_TRANSPORT" to listOf("TRUCK_DRIVER", "BUS_DRIVER", "TAXI_DRIVER", "COURIER_DRIVER", "WAREHOUSE_WORKER", "ORDER_PICKER", "LOGISTICS", "FREIGHT_FORWARDING", "DISPATCHER", "WAREHOUSE_MANAGEMENT"),
    "HOSPITALITY" to listOf("COOK", "KITCHEN_HELPER", "WAITER", "RESTAURANT_STAFF", "BAKER", "PASTRY_CHEF", "HOTEL", "FRONT_DESK", "HOUSEKEEPING"),
    "EDUCATION" to listOf("TEACHER", "EDUCATOR", "PEDAGOGUE", "PROFESSOR", "LECTURER", "TRAINER", "RESEARCH", "SCIENCE"),
    "LEGAL_SECURITY" to listOf("LAWYER", "NOTARY", "LEGAL_EXPERT", "LEGAL_ASSISTANT", "POLICE", "FIRE_DEPARTMENT", "SECURITY_SERVICE", "JUDICIARY"),
    "MANUFACTURING" to listOf("PRODUCTION_WORKER", "MACHINE_OPERATOR", "PLANT_OPERATOR", "QUALITY_CONTROL", "PRODUCTION_TECHNICIAN", "WELDER", "MANUFACTURING_GENERAL", "FOOD_PRODUCTION", "INDUSTRIAL_MECHANIC"),
    "AGRICULTURE_ENVIRONMENT" to listOf("FARMER", "GARDENER", "FORESTER", "ANIMAL_CARETAKER", "AGRICULTURAL_HELPER", "ENVIRONMENTAL_TECH", "RECYCLING"),
    "MEDIA_DESIGN" to listOf("GRAPHIC_DESIGNER", "WEB_DESIGNER", "PHOTOGRAPHER", "VIDEOGRAPHER", "JOURNALIST", "SOCIAL_MEDIA", "MARKETING", "ADVERTISING", "TRANSLATOR", "INTERPRETER"),
    "BEAUTY_PERSONAL_SERVICES" to listOf("HAIRDRESSER", "BEAUTICIAN", "NAIL_DESIGNER", "FOOT_CARE", "MASSEUR", "CLEANING_STAFF", "HOUSEHOLD_HELP"),
    "CARE_SOCIAL" to listOf("CHILDCARE", "EDUCATOR", "SOCIAL_WORKER", "ELDERLY_CARE", "CARE_WORKER", "DISABILITY_SUPPORT", "FAMILY_SUPPORT"),
    "ENGINEERING_SCIENCE" to listOf("MECHANICAL_ENGINEERING", "ELECTRICAL_ENGINEERING", "CIVIL_ENGINEERING", "INDUSTRIAL_ENGINEERING", "CHEMISTRY", "BIOLOGY", "PHYSICS", "ENVIRONMENTAL_TECH", "MECHATRONICS"),
    "SPORTS" to listOf("FOOTBALL_COACH", "SPORTS_TEACHER", "FITNESS_TRAINER", "PHYSIOTHERAPY", "SPORTS_MANAGEMENT", "SPORTS_CLUB"),
)

/** Flattened, de-duplicated view mirroring JOB_PROFESSION_CODES in listing.model.ts. */
val JOB_PROFESSION_CODES: List<String> = JOB_PROFESSIONS_BY_SECTOR.values.flatten().distinct()
